...
var _showBlock = require("./utils/show-block");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _showBlock.initChangeBlock)();
  (0, _sliders.initSliderPrograms)();
...
},{"./modules/form-validate/form":3,"./modules/menu":9,"./modules/modals/init-modals":10,"./modules/sliders":12,"./utils/ios-vh-fix":15,"./utils/show-block":17}],2:[function(require,module,exports){
"use strict";
...
var initNav = function initNav() {
  var navElement = document.querySelector('.page-header__nav');
  if (!navElement) {
    return;
  }
  var mediaQuery = window.matchMedia('(max-width: 765px)');
  var listMenuElement = navElement.querySelector('.list-menu');
  var togglerElement = navElement.querySelector('.button-container--toggle');
  var headerLinkElement = navElement.querySelector('.page-header__link');
  var changeOverlay = function changeOverlay() {
    var method = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'toggle';
...
exports.initSliderPrograms = exports.initSlider = void 0;
var initSlider = function initSlider() {
  var slider = document.querySelector('[data-slider]');
  var introSlider = new window.Swiper(slider, {
    loop: true,
    initialSLide: 3,
    slidesPerView: 1,
    pagination: {
...
var initSliderPrograms = function initSliderPrograms() {
  var sliderPrograms = document.querySelector('[data-slider="programs"]');
  var programsSlider = new window.Swiper(sliderPrograms, {
    initialSLide: 1,
    slidesPerView: 3,
    spaceBetween: 32,
    scrollbar: {
...
exports.initChangeBlock = void 0;
var initChangeBlock = function initChangeBlock(wrapper) {
  var linkElement = wrapper.querySelector('.link');
  ...
  var createBlock = function createBlock(element) {
    divElement.appendChild(buttonElement);
    element.appendChild(divElement);
  };
  var getMobileChange = function getMobileChange(event) {
    if (event.matches) {
...
exports.initChangeBlock = initChangeBlock;
